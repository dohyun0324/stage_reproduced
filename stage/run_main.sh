#!/usr/bin/env bash
release_path=../feature_extract/tvqa_plus_stage_features
#release_path=$1
...
qa_second_bert_path=../../../../home_klimt/dohyun.kim/tvqa_plus_stage_features/qa_naive.h5
sub_second_bert_path=../../../../home_klimt/dohyun.kim/tvqa_plus_stage_features/sub_naive.h5
qa_first_bert_path=../../../../home_klimt/dohyun.kim/tvqa_plus_stage_features/qa12_1_200_8_True.h5
sub_first_bert_path=../../../../home_klimt/dohyun.kim/tvqa_plus_stage_features/sub12_1_200_8_True.h5
...
srun1 --qos=ilow python main.py \
--train_path ${train_path} \
--valid_path ${valid_path} \
--sub_path ${sub_path} \
--qa_first_bert_path ${qa_first_bert_path} \
--qa_second_bert_path ${qa_second_bert_path} \
--sub_first_bert_path ${sub_first_bert_path} \
--sub_second_bert_path ${sub_second_bert_path} \
--vcpt_path ${vcpt_path} \
