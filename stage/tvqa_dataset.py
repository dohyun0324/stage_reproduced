...
class TVQADataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        #print(self.qa_bert_h5[str(qid) + "_q"])
        #print(self.qa_bert_h5[str(qid) + "_a0"])
        #print(self.qa_bert_h5[str(qid) + "_a1"])
        #print(self.qa_bert_h5[str(qid) + "_a2"])
        #print(self.qa_bert_h5[str(qid) + "_a3"])
        #print(self.qa_bert_h5[str(qid) + "_a4"])
        #print(qa_sentences[0])
        #print(self.cur_data_dict[index]["q"] + " " + self.cur_data_dict[index]['a0'])
        #print(len(qa_sentences[1]))
        #print(len(qa_sentences[2]))
        #print(len(qa_sentences[3]))
        #print(len(qa_sentences[4]))
        # add sub
        if self.sub_flag:
            ...
            #print(vid_name, len(self.sub_bert_h5[vid_name]), len(sub_bert_embed), len(raw_sub_n_tokens))
